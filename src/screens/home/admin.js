				...
				<Row className="mt-4">
					<a href="/commisioner" className="card mb-3 col-sm-3 col-md-3 col-xs-12 text-center">
		  				<div class="card-body text-white bg-success rounded">
		  					<i class="fa fa-users" style={{ fontSize: "42px" }}></i>
		    				<h5 class="card-title mt-3">Comissioners</h5>
		    				<p class="card-text">20</p>
		  				</div>
		            </a>
		            <a href="/category" className="card mb-3 col-sm-3 col-md-3 col-xs-12 text-center">
		  				<div class="card-body text-white bg-success rounded">
		  					<i class="fa fa-list-alt" style={{ fontSize: "42px" }}></i>
		    				<h5 class="card-title mt-3">Categories</h5>
		    				<p class="card-text">5</p>
		  				</div>
		            </a>
		            <a href="/article" className="card mb-3 col-sm-3 col-md-3 col-xs-12 text-center">
		  				<div class="card-body text-white bg-success rounded">
		  					<i class="fa fa-paper-plane" style={{ fontSize: "42px" }}></i>
		    				<h5 class="card-title mt-3">Article</h5>
