      ...
      passwordError, password, confirmPasswordError, confirmPassword,
		...
		return (
			...
			<Form className="p-5 box">
				...
				<Button variant="primary" type="submit" className="col-sm-12 btn-block mb-1 mt-1" onClick={this.handleSubmit}>Save password</Button>
			</Form>
			</AuthLayout>
		);
	}
...
export default connect(mapStateToProps, {createAccountPassword})(SetPasswordScreen);